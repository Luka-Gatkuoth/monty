...
#include <ctype.h>
/**
 * struct stack_s - doubly linked lists representation of the stack or queue
 * @n: integer
 * @prev: points to the previous element of stack or queue
 * @next: points to the next element of stack or queue
 *
 * Description: doubly linked lists nodes structure
...
/**
* struct bus_s - variables -args, files, line contents
* @arg: value
